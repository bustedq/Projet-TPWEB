...
--
-- Hôte : localhost
-- Généré le : mar. 27 oct. 2020 à 16:03
...
INSERT INTO `livre` (`id_livre`, `titre`, `genre`, `id_bibliotheque`, `logo`) VALUES
...
(25, 'test 123', 'test 123', 3, '5f845a810d781-ps5-logo.jpg'),
...
--
ALTER TABLE `livre`
  MODIFY `id_livre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT pour la table `publier`
--
ALTER TABLE `publier`
  MODIFY `id_publier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
