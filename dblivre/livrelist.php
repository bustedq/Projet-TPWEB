...
<table class="table table-striped custab"> 		
        <?php
            ...
            try{
                ...
                $sth = $dbco->prepare("SELECT livre.titre,livre.id_livre, livre.genre, livre.logo, auteur.nom as auteur_name, editeur.nom as editeur_name FROM livre,publier,auteur,editeur 
